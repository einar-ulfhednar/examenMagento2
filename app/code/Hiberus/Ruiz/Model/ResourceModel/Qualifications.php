...
namespace Hiberus\Ruiz\Model\ResourceModel;

use Hiberus\Ruiz\Api\Data\QualificationsInterface;
use Magento\Framework\Model\AbstractModel;
use Magento\Framework\Model\ResourceModel\Db\AbstractDb;

class Qualifications extends AbstractDb
{
    ...
    {
        $this->_init(QualificationsInterface::TABLE_NAME, QualificationsInterface::COLUMN_ID);
    }
